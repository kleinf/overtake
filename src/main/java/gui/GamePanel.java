...
public class GamePanel extends AbstractMainPanel implements Runnable {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see gui.AbstractMainPanel#initialize()
	 */
	@Override
	protected void initialize() {
		...
		status.setFont(Constants.FONT_FIELDS);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see gui.AbstractMainPanel#boardClick(java.awt.event.MouseEvent)
	 */
	@Override
	 ...
	 * @param idY
	 *            int
	 * @see gui.GamePanel#takeOver(int, int)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see gui.AbstractMainPanel#setMode(util.Mode)
	 */
	@Override
	...
	protected void setNetMode(final String mode) {
		super.setMode(Mode.valueOf(mode));
	}

	/**
	 * @see gui.GamePanel#checkWinner()
	 * @see gui.GamePanel#nextPlayer()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see gui.AbstractMainPanel#checkClick(int, int, boolean)
	 */
	@Override
